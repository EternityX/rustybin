  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast:
            "group toast group-[.toaster]:bg-[#17191A] group-[.toaster]:text-white/50 group-[.toaster]:border-[#2F3032] border border-[#2F3032] group-[.toaster]:rounded-none backdrop-blur-sm text-white/30",
